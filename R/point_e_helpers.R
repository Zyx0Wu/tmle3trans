#' Helper Functions for Point Effect
#'
...
#' @param tmle_task a \code{\link{tmle3_Task}} as constructed via \code{point_e_task}
...
#' @export
#' @rdname point_e
point_e_task <- function(data, node_list, variable_types = NULL, ...) {
  setDT(data)
  
  npsem <- point_e_npsem(node_list, variable_types)

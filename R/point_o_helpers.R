#' Helper Functions for Point Outcome
#'
...
#' @param tmle_task a \code{\link{tmle3_Task}} as constructed via \code{point_o_task}
...
#' @export
#' @rdname point_o
point_o_task <- function(data, node_list, variable_types = NULL, ...) {
  setDT(data)
  
  npsem <- point_o_npsem(node_list, variable_types)
